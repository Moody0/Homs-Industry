...
import { CheckCircle2, Factory, MapPin, ShieldCheck } from "lucide-react";
            ...
            <div className="relative flex h-full flex-col gap-12">
              ...
              <div className="space-y-5">
                <h2 className="text-4xl font-black leading-tight">
                  ادخل إلى حسابك واجعل عملك أقرب للزبائن وأكثر ربحاً.
                </h2>
          ...
          <CardContent className="order-1 p-0">
            <div className="border-b border-slate-100 bg-white px-5 py-4 sm:px-7 lg:hidden">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-lg font-black text-slate-950">صناعة حمص</p>
